...
const TopBanner = () => {
  return (
    <div className="bg-secondary py-[12px]">
      <div className="container flex flex-col md:flex-row items-center justify-between gap-[90px]">
        <div>
          <p className="text-white text-[12px] text-center md:text-left">
        ...
        <div className="flex items-center justify-end gap-[20px] max-w-[315px]">
          <Image
