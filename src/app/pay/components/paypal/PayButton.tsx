...
import {CreateOrderActions, CreateOrderRequestBody, OnApproveActions} from "@paypal/paypal-js";
...
export const PayButtons = (payload:TPayloadForPaypal) => {
    const [{ isPending, isInitial, isRejected, isResolved, options }] = usePayPalScriptReducer();
