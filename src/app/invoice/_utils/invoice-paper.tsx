  ...
  return (
    <>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-start gap-4">
                    ...
                    <div>
                      <h3 className="text-sm sm:text-normal font-bold">
                        {name}
                      </h3>
                      {item?.attributeCombinations?.combinations?.length ? (
                        <p>
                          {MakeCombinationString(item.attributeCombinations)}
                        </p>
                      ) : (
                        price
                      )}
                  ...
                  <div className="text-normal font-bold pr-4">
                    ${item.price}
                  </div>
                </div>
              );
      ...
      <div className="flex flex-col gap-4 items-center justify-center w-full">
        <div className="pt-4">
          Use <span className="px-3 py-2 rounded-[10px] bg-white border">ctrl + P</span> to
          print
        </div>
        or,
        <Button
